...
class UNETDataGenerator(tf.keras.utils.Sequence):
    ...
    def _get_naip_data(self, indexes):
        ...
        naip = self._get_x_data(files_temp,rescale_val=255.0)
    ...
    def _get_lidar_data(self, indexes):
        ...
        lidar = self._get_x_data(files_temp,add_nan_mask=True,rescale_val=100)
    ...
    def _get_dem_data(self, indexes):
        ...
        dem = self._get_x_data(files_temp,add_nan_mask=True,rescale_val=2000.0)
